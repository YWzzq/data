  ...
  <div class="data-alignment-page">
    ...
    <el-card class="task-list-card">
      ...
      >
        ...
        <el-table-column prop="alignmentMethod" label="对齐方式" min-width="200">
          <template #default="scope">
            <el-tag 
              v-for="method in scope.row.alignmentMethod" 
              :key="method"
              size="small"
              class="method-tag"
            >
...
// 任务列表数据
const tasks = ref([
  { name: '对齐任务1', dataType: 'text', alignmentMethod: ['自动对齐'], progress: 70, processed: 700, total: 1000, status: { type: 'success', text: '进行中' }, createdTime: '2024-01-01 10:00:00' },
  { name: '对齐任务2', dataType: 'image', alignmentMethod: ['手动调整'], progress: 100, processed: 500, total: 500, status: { type: 'info', text: '已完成' }, createdTime: '2024-01-02 14:30:00' },
  { name: '对齐任务3', dataType: 'text', alignmentMethod: ['自动对齐'], progress: 30, processed: 300, total: 1000, status: { type: 'warning', text: '暂停中' }, createdTime: '2024-01-03 09:15:00' }
])
...
const guideSteps = ref([
  { title: '选择数据', description: '选择需要对齐的数据集' },
  { title: '配置规则', description: '设置数据对齐规则' },
  { title: '执行对齐', description: '开始数据对齐任务' },
  { title: '结果验证', description: '验证对齐结果' }
])
