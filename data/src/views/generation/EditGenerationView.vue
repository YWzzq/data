    ...
    <el-form :model="generationForm" label-width="120px" class="generation-form">
      ...
      <el-card class="mb-20">
        ...
        <el-form-item label="生成类型" required>
          <el-tag :type="generationForm.type === 'general' ? 'success' : 'warning'">
            {{ generationForm.type === 'general' ? '一般数据生成' : '大模型微调数据' }}
          </el-tag>
        </el-form-item>
...
const loadTask = () => {
  ...
  Object.assign(generationForm.value, mockData)
}
